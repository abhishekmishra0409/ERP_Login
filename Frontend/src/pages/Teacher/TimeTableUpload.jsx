...
function TimeTableUpload() {
    ...
    const [selectedTimetableType, setSelectedTimetableType] = useState(null);
    ...
    const handleTimetableTypeSelect = (value) => {
        setSelectedTimetableType(value);
    };
    ...
    const handleCustomUpload = () => {
        if (file && selectedBatch && selectedTimetableType) {
            setLoading(true);

            const formData = new FormData();
            formData.append('batch', selectedBatch);
            formData.append('timetableType', selectedTimetableType);
            ...
            message.error('Please select a file, batch, and timetable type to upload');
        }
    };
